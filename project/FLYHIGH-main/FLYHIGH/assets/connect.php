...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_in_date = $conn->real_escape_string($_POST['check-in-date']);
    $check_out_date = $conn->real_escape_string($_POST['check-out-date']);

    // Insert data into the database
    $sql = "INSERT INTO bookings (firstname, lastname, email, phone, check_in_date, check_out_date) 
            VALUES ('$firstname', '$lastname', '$email', '$phone', '$check_in_date', '$check_out_date')";
        ...
        <nav id="navbar">
            <div class="nav-container">
                ...
                <div class="menu">
                    ...
                    <a href="https://ubiquitous-otter-4b9e40.netlify.app/">About Us</a>
...
<section class="footer">
    ...
    <div class="end">
        <p>Copyright © 2081 Adventour All Rights Reserved.</p>
    </div>
</section>
